        ...
        >
          ...
          >
            <Box display='flex' alignItems='center'>
              ...
              <Box>
                <Typography variant='h4' fontSize={22} noWrap>
                  Bitcoin
                </Typography>
            ...
            >
              <Typography color='success.main'>+$500</Typography>
              <Typography
                variant='body2'
        ...
        >
          ...
          >
            <Box display='flex' alignItems='center'>
              ...
              <Box>
                <Typography fontSize={22} variant='h4' noWrap>
                  Ethereum
                </Typography>
                <Typography variant='subtitle1' noWrap>
                  ETH
            ...
            >
              <Typography color='error.main'>-$90</Typography>
              <Typography
                variant='body2'
                color='text.secondary'
                sx={{
      ...
      <Grid item md={4} xs={12}>
        ...
        >
          ...
          >
            ...
            >
              <Typography color='error.main'>-$5</Typography>
              <Typography
                variant='body2'
                color='text.secondary'
                sx={{
